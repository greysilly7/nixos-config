  ...
  den.aspects.media._.base = {
    nixos = _: {
      ...
      systemd.tmpfiles.rules = [
        ...
        "d /var/lib/riven 0775 media media -"
        "d /var/lib/riven/db 0775 media media -"
        "d /var/lib/riven/frontend 0775 media media -"
        "d /mnt/pool/arr/media/riven 0775 media media -"
